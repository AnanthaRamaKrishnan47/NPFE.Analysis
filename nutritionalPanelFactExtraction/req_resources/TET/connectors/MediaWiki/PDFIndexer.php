 ...
 *
 * $Id: PDFIndexer.php,v 1.12.2.1 2017/01/04 14:23:14 rp Exp $
 *
 */
...
function tetUploadCompleteFileIndexer(&$image){
    ...
    $file = dirname(dirname($_SERVER["SCRIPT_FILENAME"])) . $image->getLocalFile()->url;
	...
	if($tetNewFileIndex !== false){
		$article = new Article( $image->getLocalFile()->getTitle() );
		$article->getPage();
...
$wgExtensionCredits['other'][] = array(
        ...
        'version' => '$Id: PDFIndexer.php,v 1.12.2.1 2017/01/04 14:23:14 rp Exp $',
        'description' => 'extract PDF text content with PDFlib TET and make it searchable in the Wiki.<br/><b>This extension requires MediaWiki 1.22.0 or newer. For older versions please see the PDFlib TET manual for instructions.</b>',
        'url' => 'https://www.pdflib.com/download/tet/'
        );
?>
