 ...
 * 
 * @version $Id: image_resources.java,v 1.11.2.1 2015/12/03 10:38:35 stm Exp $
 */
public class image_resources
{
     ...
     * <ul>
     * <li>image number</li>
     * <li>pCOS id (required for indexing the images[] array)</li>
     * <li>pixel size of the underlying PDF image XObject</li>
     * <li>number of components, bits per component,and colorspace</li>
     * <li>mergetype if different from "normal", i.e. "artificial" (=merged)
     *   or "consumed"</li>
     * <li>"stencilmask" property, i.e. /ImageMask in PDF</li>
     * <li>pCOS id of mask image, i.e. /Mask or /SMask in PDF</li>
     * </ul>
     *   
