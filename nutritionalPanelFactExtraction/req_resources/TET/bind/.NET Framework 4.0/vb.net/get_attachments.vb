' $Id: get_attachments.vb,v 1.3 2017/04/27 14:32:35 rp Exp $
'
...
Class get_attachments
    ...
    Shared globaloptlist As String = "searchpath={{../data} " +
   "{../../../resource/cmap}}"


    ' Document specific option list.
    Shared docoptlist As String = ""


    ' Page-specific option list.
    Shared pageoptlist As String = "granularity=page"

    ' Separator to emit after each chunk of text. This depends on the
    ' application's needs for granularity=word a space character may be
    ' useful.
    Shared separator As String = System.Environment.NewLine
    ...
    ' @throws IOException
    '/
    Shared Function extract_text(ByVal tet As TET, ByVal doc As Integer, ByVal outfp As BinaryWriter) As Integer
    ...
    Shared Function process_document(ByVal outfp As BinaryWriter, ByVal filename As String, ByVal realname As String, ByVal data() As Byte) As Integer
    ...
    ' @throws IOException
    '
    Shared Function process_document(ByVal outfp As BinaryWriter, ByVal tet As TET, ByVal doc As Integer) As Integer
    ...
    Shared Function Main(ByVal args As String()) As Integer
        ...
        Try
            ...
            ret = process_document(outfp, args.GetValue(0).ToString(), args.GetValue(0).ToString(), Nothing)
