...
'
' $Id: dumper.vb,v 1.10 2010/01/21 16:05:53 stm Exp $
'
...
Class Dumper
  Shared Function Main(ByVal args As String()) As Integer
    ...
    Dim searchpath As String = "{../data} {../../data}"
    ...
    Try
        ...
        doc = tet.open_document(Args(0), docoptlist)
        If doc = -1 Then
        ...
        s = "   File name: " & tet.pcos_get_string(doc, "filename") & separator
            ...
            s = s & " PDF version: " & tet.pcos_get_string(doc, "pdfversionstring") _
                & separator
