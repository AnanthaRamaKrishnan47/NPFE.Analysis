/*---------------------------------------------------------------------------*
 |          Copyright (c) 2002-2016 PDFlib GmbH. All rights reserved.        |
 +---------------------------------------------------------------------------+
...
/* $Id: dl_dl.h,v 1.4 2017/01/16 15:21:20 rjs Exp $
 *
...
/* ------------------ Linux & Mac OS X and other Unixes --------------------- */
    ...
    || defined (__FreeBSD__) || defined (__HOS_AIX__) || defined(__hpux)
